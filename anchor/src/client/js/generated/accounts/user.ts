...
export function getUserEncoder(): Encoder<UserArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['published', getU16Encoder()],
      ['purchased', getU16Encoder()],
      ['sold', getU16Encoder()],
      ['reviewed', getU16Encoder()],
      ['earning', getU64Encoder()],
...
export function getUserDecoder(): Decoder<User> {
  return getStructDecoder([
    ...
    ['published', getU16Decoder()],
    ['purchased', getU16Decoder()],
    ['sold', getU16Decoder()],
    ['reviewed', getU16Decoder()],
    ['earning', getU64Decoder()],
